...
from dwave.system import ReverseAdvanceComposite, DWaveCliqueSampler, ReverseBatchStatesComposite, DWaveSampler
...
class MOQASolver:
    ...
    def solve(problem: QP, num_reads: int, sample_times: int = 1, 
        ...
        for _ in range(sample_times):
            ...
            reverse_sampler = ReverseBatchStatesComposite(DWaveSampler())
